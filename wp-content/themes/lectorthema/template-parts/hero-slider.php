<?php
/**
 * LectorThema - Template Part: Hero Slider (Lo Más Visto en Grande)
 *
...
if ($featured_query->have_posts()):
?>
<section class="hero-slider-section" aria-label="<?php esc_attr_e('Obras Más Vistas y Destacadas', 'lectorthema'); ?>">
    <div class="nexus-container">
        ...
        <div class="hero-slides-track">
            <?php while ($featured_query->have_posts()): $featured_query->the_post();
                ...
                $last_chap_time = $last_chap_obj ? lectorthema_time_ago(get_the_time('U', $last_chap_obj->ID)) : '';
                        ...
                        <div class="hero-slide-info">
                            ...
                            <?php if ($last_chap_obj): ?>
                                <div class="hero-latest-chapter-meta">
                                    <span class="hero-chap-label"><?php _e('Último:', 'lectorthema'); ?></span>
                                    <a href="<?php echo esc_url(get_permalink($last_chap_obj->ID)); ?>" class="hero-chap-badge">
                                        <i class="fa-solid fa-book-open"></i> <?php printf(__('Cap. %s', 'lectorthema'), esc_html($last_chap_num)); ?>
                                    </a>
                            ...
                            <div class="hero-slide-cta">
                                <a href="<?php the_permalink(); ?>" class="btn-hero-read">
                                    <i class="fa-solid fa-play"></i> <?php _e('Leer Ahora', 'lectorthema'); ?>
                                </a>
                                ...
                                <button type="button" 
                                    ...
                                    <span class="btn-fav-label"><?php echo $is_fav ? __('En Favoritos', 'lectorthema') : __('Guardar', 'lectorthema'); ?></span>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="hero-slider-bottom-controls">
            ...
            <div class="hero-slider-nav-group">
                <button class="hero-slider-nav hero-slider-prev" aria-label="<?php esc_attr_e('Anterior', 'lectorthema'); ?>">
                    <i class="fa-solid fa-chevron-left"></i>
                </button>
                <button class="hero-slider-nav hero-slider-next" aria-label="<?php esc_attr_e('Siguiente', 'lectorthema'); ?>">
