<?php
/**
 * MangaNexus - Taxonomy Template: Género
 *
 * @package MangaNexus
 */
    ...
    <div class="nexus-container">
        ...
        <div class="section-header-block">
            <h1 class="section-title">
                ...
                <?php printf(__('Género: %s', 'manga-nexus'), esc_html($current_term->name)); ?>
            </h1>
        </div>
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 60px 20px; background: var(--bg-surface); border-radius: var(--radius-lg);">
                <p style="color: var(--text-muted);"><?php printf(__('No hay obras registradas con el género %s.', 'manga-nexus'), esc_html($current_term->name)); ?></p>
            </div>
        <?php endif; ?>
