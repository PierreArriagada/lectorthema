<?php
/**
 * MangaNexus - Front Page Template (Portada Principal)
 *
 * Estructura:
        ...
        <div class="home-main-layout" style="display: grid; grid-template-columns: 1fr 320px; gap: 30px; margin-top: 25px;">
                ...
                <section class="latest-updates-section" style="margin-top: 15px;">
                    <div class="section-header-block">
                        <h2 class="section-title">
                            <i class="fa-solid fa-bolt-lightning"></i> <?php _e('Últimos Capítulos Agregados', 'manga-nexus'); ?>
                        </h2>
                        <a href="<?php echo esc_url(home_url('/mangas/')); ?>" class="section-more-link">
                            <?php _e('Ver Todos', 'manga-nexus'); ?> <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                    ...
                    <?php else: ?>
                        <p style="color: var(--text-muted); padding: 40px 0; text-align: center;">
                            <?php _e('No hay mangas registrados en el catálogo.', 'manga-nexus'); ?>
                        </p>
                    <?php endif; ?>
                </section>
            ...
            <aside class="home-sidebar-col">
                ...
                <div class="top-rankings-box">
                    <div class="section-header-block" style="margin-bottom: 15px;">
                        <h3 class="section-title" style="font-size: 16px;">
                            <i class="fa-solid fa-crown" style="color: var(--warning);"></i> <?php _e('Joyas Ocultas & Fan Comics', 'manga-nexus'); ?>
                        </h3>
                    </div>
                ...
                <div class="top-rankings-box" style="margin-top: 25px;">
                    <div class="section-header-block" style="margin-bottom: 15px;">
                        <h3 class="section-title" style="font-size: 16px;">
                            <i class="fa-solid fa-layer-group" style="color: var(--primary);"></i> <?php _e('Formatos de Lectura', 'manga-nexus'); ?>
                        </h3>
                    </div>
