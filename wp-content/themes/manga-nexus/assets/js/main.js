...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginForm) {
      loginForm.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          formData.append('action', 'manga_nexus_ajax_login');
          formData.append('security', mangaNexusData.nonce);

          const res = await fetch(mangaNexusData.ajaxUrl, {
            method: 'POST',
            body: formData
          });
    ...
    if (registerForm) {
      registerForm.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          formData.append('action', 'manga_nexus_ajax_register');
          formData.append('security', mangaNexusData.nonce);
  ...
  if (btnThemeToggle) {
    btnThemeToggle.addEventListener('click', () => {
      ...
      localStorage.setItem('mangaNexusTheme', newTheme);
    });
  }
});
