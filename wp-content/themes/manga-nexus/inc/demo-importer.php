<?php
/**
 * MangaNexus - Importador de Datos Demo Automático
 *
...
function manga_nexus_auto_seed_demo_data() {
    ...
    foreach ($demo_mangas as $item) {
        ...
        if ($post_id && !is_wp_error($post_id)) {
            ...
            manga_nexus_seed_manga_views($post_id);
        }
    }
}
add_action('after_switch_theme', 'manga_nexus_auto_seed_demo_data');
add_action('admin_init', 'manga_nexus_auto_seed_demo_data');

function manga_nexus_seed_manga_views($manga_id) {
    global $wpdb;
